...
Three of the created legacy palettes (`electric.brights`, `just.beachy` and `cycling.hills`) contain 5 colours each, two legacy palettes (`clear.skies` and `mountain.train`) contain 6 colours each, and only one legacy palette (`main.palette`) contain 4 colours each, and meet WCAG 2.0 AAA guidance. 
